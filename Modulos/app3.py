def minha_funcao(): #Definindo uma função chamada minha_funcao que encapsula o código para criar um objeto da classe Pessoa e lidar com possíveis exceções relacionadas à idade. Isso ajuda a organizar o código e torna mais fácil reutilizá-lo em diferentes partes do programa.
